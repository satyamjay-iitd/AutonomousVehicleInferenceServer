...
if __name__ == '__main__':
	...
	img = cv2.imread("/home/janib/Downloads/Editor/AutonomousDriving-Refactored/Inference_Server/DeterministicLaneDetection/983.png")
	output = inference(get_lane_agent(), img, get_homography_matrix()[1])
	print(output)
